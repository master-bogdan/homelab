...
import { clearSession } from '@/modules/auth/store';
import type { OAuthTokenResponseDto } from '@/modules/auth/types';
  ...
  if (!refreshPromise) {
    refreshPromise = (async () => {
      ...
      if (refreshResult.data) {
        const data = refreshResult.data as OAuthTokenResponseDto;
